 ...
 * questions.
 */
package com.sovava.util.stream;
...
final class Nodes {
    ...
    private static abstract class SizedCollectorTask<P_IN, P_OUT, T_SINK extends Sink<P_OUT>,
        ...
        static final class OfRef<P_IN, P_OUT>
            ...
            OfRef(Nodes.SizedCollectorTask.OfRef<P_IN, P_OUT> parent, Spliterator<P_IN> spliterator,
            ...
            @Override
            Nodes.SizedCollectorTask.OfRef<P_IN, P_OUT> makeChild(Spliterator<P_IN> spliterator,
    ...
    private static abstract class ToArrayTask<T, T_NODE extends Node<T>,
        ...
        private static final class OfRef<T>
            ...
            private OfRef(Nodes.ToArrayTask.OfRef<T> parent, Node<T> node, int offset) {
                super(parent, node, offset);
                this.array = parent.array;
            }

            @Override
            Nodes.ToArrayTask.OfRef<T> makeChild(int childIndex, int offset) {
                return new Nodes.ToArrayTask.OfRef<>(this, node.getChild(childIndex), offset);
            }
        ...
        private static class OfPrimitive<T, T_CONS, T_ARR,
            ...
            private OfPrimitive(Nodes.ToArrayTask.OfPrimitive<T, T_CONS, T_ARR, T_SPLITR, T_NODE> parent, T_NODE node, int offset) {
                super(parent, node, offset);
                this.array = parent.array;
            }

            @Override
            Nodes.ToArrayTask.OfPrimitive<T, T_CONS, T_ARR, T_SPLITR, T_NODE> makeChild(int childIndex, int offset) {
                return new Nodes.ToArrayTask.OfPrimitive<>(this, node.getChild(childIndex), offset);
            }
