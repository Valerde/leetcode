...
class SpinedBuffer<E>
    ...
    static class OfInt extends OfPrimitive<Integer, int[], IntConsumer>
        ...
        public Spliterator.OfInt spliterator() {
            class Splitr extends SpinedBuffer.OfPrimitive.BaseSpliterator<Spliterator.OfInt>
    ...
    static class OfLong extends OfPrimitive<Long, long[], LongConsumer>
        ...
        public Spliterator.OfLong spliterator() {
            class Splitr extends SpinedBuffer.OfPrimitive.BaseSpliterator<Spliterator.OfLong>
    ...
    static class OfDouble
        ...
        public Spliterator.OfDouble spliterator() {
            class Splitr extends SpinedBuffer.OfPrimitive.BaseSpliterator<Spliterator.OfDouble>
